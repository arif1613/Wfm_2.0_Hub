...
{
    public class when_retrieving_a_read_policy_by_name : TestBase
    {
        ...
        private Because of = () => _policy = MediaApi.GetAccessPolicyByName(_originalPolicy.Name, ConnectionString).Result;
