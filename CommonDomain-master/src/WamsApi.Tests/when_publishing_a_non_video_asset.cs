...
{
    class when_publishing_a_non_video_asset : TestBase
    {
        ...
        private Because of = () =>
            {
                _publishUrl = MediaApi.PublishAsset(_asset, _policy, ConnectionString).Result;
            };
        ...
        private It a_publish_url_should_be_returned = () => _publishUrl.ShouldContain(_assetFileName);
