...
{
    public class when_retrieving_a_locator_by_asset_id : TestBase
    {
        ...
        private Because of = () => _locator = MediaApi.GetLocator(_asset.Id, _policy.Id, ConnectionString).Result;
