...
{
    public class when_receiving_a_change_request_for_a_resource_belonging_to_a_different_context_than_the_path
    {
        ...
        private static Guid _resourceOwnerId;
        ...
        private Establish context = () =>
        {
            ...
            SecurityTestBootstrapper.ClientCredentialsList = new List<ClientCredentials>
            {
                    new ClientCredentials
                    {
                            ...
                            HolderId = _resourceOwnerId.AsId(typeof(HolderWithClients)),
