...
{
    class when_receiving_a_request_to_retrieve_a_non_existing_holder
    {
        ...
        private It the_result_should_be_Not_Found = () => _result.StatusCode.ShouldEqual(HttpStatusCode.NotFound);
    }
}
